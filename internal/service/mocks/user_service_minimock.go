...
//go:generate minimock -i github.com/katyafirstova/auth_service/internal/service.UserService -o user_service_minimock.go -n UserServiceMock -p mocks
...
func (mmCreate *mUserServiceMockCreate) Expect(ctx context.Context, req model.CreateUser) *mUserServiceMockCreate {
...
// ExpectReqParam2 sets up expected param req for UserService.Create
func (mmCreate *mUserServiceMockCreate) ExpectReqParam2(req model.CreateUser) *mUserServiceMockCreate {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("UserServiceMock.Create mock is already set by Set")
	}
...
func (mmCreate *mUserServiceMockCreate) Inspect(f func(ctx context.Context, req model.CreateUser)) *mUserServiceMockCreate {
...
func (mmCreate *mUserServiceMockCreate) Set(f func(ctx context.Context, req model.CreateUser) (s1 string, err error)) *UserServiceMock {
	if mmCreate.defaultExpectation != nil {
...
// Then helper
func (mmCreate *mUserServiceMockCreate) When(ctx context.Context, req model.CreateUser) *UserServiceMockCreateExpectation {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("UserServiceMock.Create mock is already set by Set")
	}
...
func (mmCreate *UserServiceMock) Create(ctx context.Context, req model.CreateUser) (s1 string, err error) {
	...
	if mmCreate.CreateMock.defaultExpectation != nil {
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.req != nil && !minimock.Equal(*mm_want_ptrs.req, mm_got.req) {
				mmCreate.t.Errorf("UserServiceMock.Create got unexpected parameter req, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
...
func (mmDelete *mUserServiceMockDelete) Expect(ctx context.Context, uuid string) *mUserServiceMockDelete {
	...
	mmDelete.defaultExpectation.params = &UserServiceMockDeleteParams{ctx, uuid}
...
// ExpectUuidParam2 sets up expected param uuid for UserService.Delete
func (mmDelete *mUserServiceMockDelete) ExpectUuidParam2(uuid string) *mUserServiceMockDelete {
	if mmDelete.mock.funcDelete != nil {
		mmDelete.mock.t.Fatalf("UserServiceMock.Delete mock is already set by Set")
	}
...
func (mmDelete *mUserServiceMockDelete) Inspect(f func(ctx context.Context, uuid string)) *mUserServiceMockDelete {
...
func (mmDelete *mUserServiceMockDelete) Set(f func(ctx context.Context, uuid string) (err error)) *UserServiceMock {
	if mmDelete.defaultExpectation != nil {
...
// Then helper
func (mmDelete *mUserServiceMockDelete) When(ctx context.Context, uuid string) *UserServiceMockDeleteExpectation {
	if mmDelete.mock.funcDelete != nil {
		mmDelete.mock.t.Fatalf("UserServiceMock.Delete mock is already set by Set")
	}
	...
	expectation := &UserServiceMockDeleteExpectation{
		mock:               mmDelete.mock,
		params:             &UserServiceMockDeleteParams{ctx, uuid},
...
func (mmDelete *UserServiceMock) Delete(ctx context.Context, uuid string) (err error) {
	...
	mm_params := UserServiceMockDeleteParams{ctx, uuid}
	...
	if mmDelete.DeleteMock.defaultExpectation != nil {
		...
		mm_got := UserServiceMockDeleteParams{ctx, uuid}
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.uuid != nil && !minimock.Equal(*mm_want_ptrs.uuid, mm_got.uuid) {
				mmDelete.t.Errorf("UserServiceMock.Delete got unexpected parameter uuid, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
	...
	mmDelete.t.Fatalf("Unexpected call to UserServiceMock.Delete. %v %v", ctx, uuid)
	return
}
...
func (mmGet *mUserServiceMockGet) Expect(ctx context.Context, uuid string) *mUserServiceMockGet {
	...
	mmGet.defaultExpectation.params = &UserServiceMockGetParams{ctx, uuid}
...
// ExpectUuidParam2 sets up expected param uuid for UserService.Get
func (mmGet *mUserServiceMockGet) ExpectUuidParam2(uuid string) *mUserServiceMockGet {
	if mmGet.mock.funcGet != nil {
		mmGet.mock.t.Fatalf("UserServiceMock.Get mock is already set by Set")
	}
...
func (mmGet *mUserServiceMockGet) Inspect(f func(ctx context.Context, uuid string)) *mUserServiceMockGet {
...
func (mmGet *mUserServiceMockGet) Return(u1 model.User, err error) *UserServiceMock {
	if mmGet.mock.funcGet != nil {
		mmGet.mock.t.Fatalf("UserServiceMock.Get mock is already set by Set")
	}
...
func (mmGet *mUserServiceMockGet) Set(f func(ctx context.Context, uuid string) (u1 model.User, err error)) *UserServiceMock {
	if mmGet.defaultExpectation != nil {
...
// Then helper
func (mmGet *mUserServiceMockGet) When(ctx context.Context, uuid string) *UserServiceMockGetExpectation {
	if mmGet.mock.funcGet != nil {
		mmGet.mock.t.Fatalf("UserServiceMock.Get mock is already set by Set")
	}
	...
	expectation := &UserServiceMockGetExpectation{
		mock:               mmGet.mock,
		params:             &UserServiceMockGetParams{ctx, uuid},
...
func (e *UserServiceMockGetExpectation) Then(u1 model.User, err error) *UserServiceMock {
...
func (mmGet *UserServiceMock) Get(ctx context.Context, uuid string) (u1 model.User, err error) {
	...
	mm_params := UserServiceMockGetParams{ctx, uuid}
	...
	if mmGet.GetMock.defaultExpectation != nil {
		...
		mm_got := UserServiceMockGetParams{ctx, uuid}
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.uuid != nil && !minimock.Equal(*mm_want_ptrs.uuid, mm_got.uuid) {
				mmGet.t.Errorf("UserServiceMock.Get got unexpected parameter uuid, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
	...
	mmGet.t.Fatalf("Unexpected call to UserServiceMock.Get. %v %v", ctx, uuid)
	return
}
...
func (mmUpdate *mUserServiceMockUpdate) Expect(ctx context.Context, uuid string, req model.UpdateUser) *mUserServiceMockUpdate {
	...
	mmUpdate.defaultExpectation.params = &UserServiceMockUpdateParams{ctx, uuid, req}
...
// ExpectUuidParam2 sets up expected param uuid for UserService.Update
func (mmUpdate *mUserServiceMockUpdate) ExpectUuidParam2(uuid string) *mUserServiceMockUpdate {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("UserServiceMock.Update mock is already set by Set")
	}
...
// ExpectReqParam3 sets up expected param req for UserService.Update
func (mmUpdate *mUserServiceMockUpdate) ExpectReqParam3(req model.UpdateUser) *mUserServiceMockUpdate {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("UserServiceMock.Update mock is already set by Set")
	}
...
func (mmUpdate *mUserServiceMockUpdate) Inspect(f func(ctx context.Context, uuid string, req model.UpdateUser)) *mUserServiceMockUpdate {
...
func (mmUpdate *mUserServiceMockUpdate) Set(f func(ctx context.Context, uuid string, req model.UpdateUser) (err error)) *UserServiceMock {
	if mmUpdate.defaultExpectation != nil {
...
// Then helper
func (mmUpdate *mUserServiceMockUpdate) When(ctx context.Context, uuid string, req model.UpdateUser) *UserServiceMockUpdateExpectation {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("UserServiceMock.Update mock is already set by Set")
	}
	...
	expectation := &UserServiceMockUpdateExpectation{
		mock:               mmUpdate.mock,
		params:             &UserServiceMockUpdateParams{ctx, uuid, req},
...
func (mmUpdate *UserServiceMock) Update(ctx context.Context, uuid string, req model.UpdateUser) (err error) {
	...
	mm_params := UserServiceMockUpdateParams{ctx, uuid, req}
	...
	if mmUpdate.UpdateMock.defaultExpectation != nil {
		...
		mm_got := UserServiceMockUpdateParams{ctx, uuid, req}
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.uuid != nil && !minimock.Equal(*mm_want_ptrs.uuid, mm_got.uuid) {
				mmUpdate.t.Errorf("UserServiceMock.Update got unexpected parameter uuid, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
			...
			if mm_want_ptrs.req != nil && !minimock.Equal(*mm_want_ptrs.req, mm_got.req) {
				mmUpdate.t.Errorf("UserServiceMock.Update got unexpected parameter req, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
	...
	mmUpdate.t.Fatalf("Unexpected call to UserServiceMock.Update. %v %v %v", ctx, uuid, req)
	return
}
