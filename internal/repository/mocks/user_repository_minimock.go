...
//go:generate minimock -i github.com/katyafirstova/auth_service/internal/repository.UserRepository -o user_repository_minimock.go -n UserRepositoryMock -p mocks
...
type UserRepositoryMock struct {
	...
	funcCreate          func(ctx context.Context, req model.CreateUser) (s1 string, err error)
	funcCreateOrigin    string
	inspectFuncCreate   func(ctx context.Context, req model.CreateUser)
	...
	funcGet          func(ctx context.Context, uuid string) (u1 model.User, err error)
	funcGetOrigin    string
	inspectFuncGet   func(ctx context.Context, uuid string)
	afterGetCounter  uint64
	beforeGetCounter uint64
	GetMock          mUserRepositoryMockGet

	funcUpdate          func(ctx context.Context, uuid string, req model.UpdateUser) (err error)
	funcUpdateOrigin    string
	inspectFuncUpdate   func(ctx context.Context, uuid string, req model.UpdateUser)
...
func (mmCreate *mUserRepositoryMockCreate) Expect(ctx context.Context, req model.CreateUser) *mUserRepositoryMockCreate {
...
// ExpectReqParam2 sets up expected param req for UserRepository.Create
func (mmCreate *mUserRepositoryMockCreate) ExpectReqParam2(req model.CreateUser) *mUserRepositoryMockCreate {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("UserRepositoryMock.Create mock is already set by Set")
	}
...
func (mmCreate *mUserRepositoryMockCreate) Inspect(f func(ctx context.Context, req model.CreateUser)) *mUserRepositoryMockCreate {
...
func (mmCreate *mUserRepositoryMockCreate) Set(f func(ctx context.Context, req model.CreateUser) (s1 string, err error)) *UserRepositoryMock {
	if mmCreate.defaultExpectation != nil {
...
// Then helper
func (mmCreate *mUserRepositoryMockCreate) When(ctx context.Context, req model.CreateUser) *UserRepositoryMockCreateExpectation {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("UserRepositoryMock.Create mock is already set by Set")
	}
...
func (mmCreate *UserRepositoryMock) Create(ctx context.Context, req model.CreateUser) (s1 string, err error) {
	...
	if mmCreate.CreateMock.defaultExpectation != nil {
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.req != nil && !minimock.Equal(*mm_want_ptrs.req, mm_got.req) {
				mmCreate.t.Errorf("UserRepositoryMock.Create got unexpected parameter req, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
...
func (mmDelete *mUserRepositoryMockDelete) Expect(ctx context.Context, uuid string) *mUserRepositoryMockDelete {
	...
	mmDelete.defaultExpectation.params = &UserRepositoryMockDeleteParams{ctx, uuid}
...
// ExpectUuidParam2 sets up expected param uuid for UserRepository.Delete
func (mmDelete *mUserRepositoryMockDelete) ExpectUuidParam2(uuid string) *mUserRepositoryMockDelete {
	if mmDelete.mock.funcDelete != nil {
		mmDelete.mock.t.Fatalf("UserRepositoryMock.Delete mock is already set by Set")
	}
...
func (mmDelete *mUserRepositoryMockDelete) Inspect(f func(ctx context.Context, uuid string)) *mUserRepositoryMockDelete {
...
func (mmDelete *mUserRepositoryMockDelete) Set(f func(ctx context.Context, uuid string) (err error)) *UserRepositoryMock {
	if mmDelete.defaultExpectation != nil {
...
// Then helper
func (mmDelete *mUserRepositoryMockDelete) When(ctx context.Context, uuid string) *UserRepositoryMockDeleteExpectation {
	if mmDelete.mock.funcDelete != nil {
		mmDelete.mock.t.Fatalf("UserRepositoryMock.Delete mock is already set by Set")
	}
	...
	expectation := &UserRepositoryMockDeleteExpectation{
		mock:               mmDelete.mock,
		params:             &UserRepositoryMockDeleteParams{ctx, uuid},
...
func (mmDelete *UserRepositoryMock) Delete(ctx context.Context, uuid string) (err error) {
	...
	mm_params := UserRepositoryMockDeleteParams{ctx, uuid}
	...
	if mmDelete.DeleteMock.defaultExpectation != nil {
		...
		mm_got := UserRepositoryMockDeleteParams{ctx, uuid}
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.uuid != nil && !minimock.Equal(*mm_want_ptrs.uuid, mm_got.uuid) {
				mmDelete.t.Errorf("UserRepositoryMock.Delete got unexpected parameter uuid, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
	...
	mmDelete.t.Fatalf("Unexpected call to UserRepositoryMock.Delete. %v %v", ctx, uuid)
	return
}
...
func (mmGet *mUserRepositoryMockGet) Expect(ctx context.Context, uuid string) *mUserRepositoryMockGet {
	...
	mmGet.defaultExpectation.params = &UserRepositoryMockGetParams{ctx, uuid}
...
// ExpectUuidParam2 sets up expected param uuid for UserRepository.Get
func (mmGet *mUserRepositoryMockGet) ExpectUuidParam2(uuid string) *mUserRepositoryMockGet {
	if mmGet.mock.funcGet != nil {
		mmGet.mock.t.Fatalf("UserRepositoryMock.Get mock is already set by Set")
	}
	...
	mmGet.defaultExpectation.paramPtrs.uuid = &uuid
	mmGet.defaultExpectation.expectationOrigins.originUuid = minimock.CallerInfo(1)

	return mmGet
}

// Inspect accepts an inspector function that has same arguments as the UserRepository.Get
func (mmGet *mUserRepositoryMockGet) Inspect(f func(ctx context.Context, uuid string)) *mUserRepositoryMockGet {
...
func (mmGet *mUserRepositoryMockGet) Return(u1 model.User, err error) *UserRepositoryMock {
	if mmGet.mock.funcGet != nil {
		mmGet.mock.t.Fatalf("UserRepositoryMock.Get mock is already set by Set")
	}
	...
	mmGet.defaultExpectation.results = &UserRepositoryMockGetResults{u1, err}
	mmGet.defaultExpectation.returnOrigin = minimock.CallerInfo(1)
	return mmGet.mock
}

// Set uses given function f to mock the UserRepository.Get method
func (mmGet *mUserRepositoryMockGet) Set(f func(ctx context.Context, uuid string) (u1 model.User, err error)) *UserRepositoryMock {
	if mmGet.defaultExpectation != nil {
...
// Then helper
func (mmGet *mUserRepositoryMockGet) When(ctx context.Context, uuid string) *UserRepositoryMockGetExpectation {
	if mmGet.mock.funcGet != nil {
		mmGet.mock.t.Fatalf("UserRepositoryMock.Get mock is already set by Set")
	}
	...
	expectation := &UserRepositoryMockGetExpectation{
		mock:               mmGet.mock,
		params:             &UserRepositoryMockGetParams{ctx, uuid},
...
func (e *UserRepositoryMockGetExpectation) Then(u1 model.User, err error) *UserRepositoryMock {
	e.results = &UserRepositoryMockGetResults{u1, err}
	return e.mock
}
...
func (mmGet *UserRepositoryMock) Get(ctx context.Context, uuid string) (u1 model.User, err error) {
	...
	if mmGet.inspectFuncGet != nil {
		mmGet.inspectFuncGet(ctx, uuid)
	}

	mm_params := UserRepositoryMockGetParams{ctx, uuid}
	...
	if mmGet.GetMock.defaultExpectation != nil {
		...
		mm_got := UserRepositoryMockGetParams{ctx, uuid}
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.uuid != nil && !minimock.Equal(*mm_want_ptrs.uuid, mm_got.uuid) {
				mmGet.t.Errorf("UserRepositoryMock.Get got unexpected parameter uuid, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmGet.GetMock.defaultExpectation.expectationOrigins.originUuid, *mm_want_ptrs.uuid, mm_got.uuid, minimock.Diff(*mm_want_ptrs.uuid, mm_got.uuid))
			}
	...
	if mmGet.funcGet != nil {
		return mmGet.funcGet(ctx, uuid)
	}
	mmGet.t.Fatalf("Unexpected call to UserRepositoryMock.Get. %v %v", ctx, uuid)
	return
}
...
func (mmUpdate *mUserRepositoryMockUpdate) Expect(ctx context.Context, uuid string, req model.UpdateUser) *mUserRepositoryMockUpdate {
	...
	mmUpdate.defaultExpectation.params = &UserRepositoryMockUpdateParams{ctx, uuid, req}
...
// ExpectUuidParam2 sets up expected param uuid for UserRepository.Update
func (mmUpdate *mUserRepositoryMockUpdate) ExpectUuidParam2(uuid string) *mUserRepositoryMockUpdate {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("UserRepositoryMock.Update mock is already set by Set")
	}
...
// ExpectReqParam3 sets up expected param req for UserRepository.Update
func (mmUpdate *mUserRepositoryMockUpdate) ExpectReqParam3(req model.UpdateUser) *mUserRepositoryMockUpdate {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("UserRepositoryMock.Update mock is already set by Set")
	}
...
func (mmUpdate *mUserRepositoryMockUpdate) Inspect(f func(ctx context.Context, uuid string, req model.UpdateUser)) *mUserRepositoryMockUpdate {
...
func (mmUpdate *mUserRepositoryMockUpdate) Set(f func(ctx context.Context, uuid string, req model.UpdateUser) (err error)) *UserRepositoryMock {
	if mmUpdate.defaultExpectation != nil {
...
// Then helper
func (mmUpdate *mUserRepositoryMockUpdate) When(ctx context.Context, uuid string, req model.UpdateUser) *UserRepositoryMockUpdateExpectation {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("UserRepositoryMock.Update mock is already set by Set")
	}
	...
	expectation := &UserRepositoryMockUpdateExpectation{
		mock:               mmUpdate.mock,
		params:             &UserRepositoryMockUpdateParams{ctx, uuid, req},
...
func (mmUpdate *UserRepositoryMock) Update(ctx context.Context, uuid string, req model.UpdateUser) (err error) {
	...
	if mmUpdate.inspectFuncUpdate != nil {
		mmUpdate.inspectFuncUpdate(ctx, uuid, req)
	}

	mm_params := UserRepositoryMockUpdateParams{ctx, uuid, req}
	...
	if mmUpdate.UpdateMock.defaultExpectation != nil {
		...
		mm_got := UserRepositoryMockUpdateParams{ctx, uuid, req}
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.uuid != nil && !minimock.Equal(*mm_want_ptrs.uuid, mm_got.uuid) {
				mmUpdate.t.Errorf("UserRepositoryMock.Update got unexpected parameter uuid, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
			...
			if mm_want_ptrs.req != nil && !minimock.Equal(*mm_want_ptrs.req, mm_got.req) {
				mmUpdate.t.Errorf("UserRepositoryMock.Update got unexpected parameter req, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
	...
	if mmUpdate.funcUpdate != nil {
		return mmUpdate.funcUpdate(ctx, uuid, req)
	}
	mmUpdate.t.Fatalf("Unexpected call to UserRepositoryMock.Update. %v %v %v", ctx, uuid, req)
	return
}
